...
--    resulting CFG.
module Language.Hic.Core.DataFlow
    ( CFGNode (..)
    , CFG
    , DataFlow (..)
    , fixpoint
...
import qualified Language.Hic.Core.CFG      as CFGBuilder
import           Language.Hic.Core.Types    (lookupOrError)
import           Language.Hic.Core.Worklist
