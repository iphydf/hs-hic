...
module Language.Hic.Core.ScopeSpec (spec) where
...
import           Language.Hic.Core.Scope
import           Language.Hic.Inference.EngineSpec (mustParseNodes)
import           Test.Hspec
